...
<head>
 ...
 <?php
                $connect = mysqli_connect('localhost', 'root', '1234', 'board') or die ("connect fail");
...
<?php
        ...
        <br />
        <iframe src="https://192.168.200.137/index.php" id="iframe" widkth="800px" height="600px"></iframe> 
